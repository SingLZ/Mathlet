...
problems = [
    Problem(Equation=f'{Frac(1,2)} + {Frac(1,3)}', 
        Steps=[Step(rf'{Frac(3, 6)} + {Frac(2, 6)}', 
                    rf'Multiply {Frac(1,2)} by {Frac(3,3)} and {Frac(1,3)} by {Frac(2,2)}', 
                    (rf'Multiply {Frac(1,2)} by {Frac(2,2)} and {Frac(1,3)} by {Frac(3,3)}', rf'Multiply {Frac(1,2)} by {Frac(2,1)} and {Frac(1,3)} by {Frac(3,1)}', rf'Divide {Frac(1,2)} by {Frac(3,3)} and {Frac(1,3)} by {Frac(2,1)}'),
                    feedback='Step 1'
                    ),
