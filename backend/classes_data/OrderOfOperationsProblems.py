...
problems = [
    Problem(Equation='2+4-9x2 = ?',
            Steps=[Step(result='2+4-18 = ?',
                    ...
                    Step(result='6-18 = ?',
                        ...
                        wrong_steps=
                        (Step(step='2+4 = -2',
                              feedback='Incorrect - 2 + 4 does not equal -2'),
                         Step(step='2+18 = 20',
    ...
    Problem(Equation='4x5-3+(2+4) = ?',
            Steps=[Step(result='4x5-3+6 = ?',
                        step='2+4 = 6',
    ...
    Problem(Equation='2-6x(5-1)/2 = ?',
            Steps=[Step(result='2-6x4/2 = ?',
                        step='(5-1) = 4',
                        feedback='Correct! We use PEMDAS and start with parentheses',
                        wrong_steps=
                        (Step(step='2-6 = -4',
